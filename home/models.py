...
class Devices(models.Model):
    ...
    baud_rate = models.CharField(max_length=255, null=True, blank=True)
    word_length = models.CharField(max_length=255, null=True, blank=True)
    parity = models.CharField(max_length=255, null=True, blank=True)
    stop_bits = models.CharField(max_length=255, null=True, blank=True)
